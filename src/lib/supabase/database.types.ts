...
//
// El proyecto de Supabase esta compartido con otras apps. En admin-adala solo
// nos importan las tablas con prefijo `adala_`; las `ra_` (reels-analytics) y
// `home_` (admin-home) aparecen aqui porque el generador exporta todo el schema
// public, pero no se consultan desde esta app.
...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      adala_form_healthcheck: { Args: never; Returns: Json }
      adala_is_admin: { Args: never; Returns: boolean }
    }
    Enums: {
